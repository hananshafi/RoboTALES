...
from ..modules.critic_model.llava_cycle_critic import LlavaCycleRewardCritic
...
class DiffusionEngine(pl.LightningModule):
    def __init__(
        ...
        self.critic = LlavaCycleRewardCritic(device="cuda", num_frames=25)
    ...
    def awr_training_step(self, batch, beta: float = 0.5, ema: float = 0.9):
        ...
        **sampler_kwargs,
        ...
        rewards = []
        for i in range(B):
            reward_info = self.critic.score_frames_direct(
            frames=videos_np[i],
            instruction=batch["instruction"][i],  # Direct instruction alignment
            )
