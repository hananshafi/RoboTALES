...
try:
    ...
    print("#" * 100)
    # Don't exit — sdata is only needed for StableDataModuleFromConfig,
    # not for VideoDatasetModule which is used in robocasa training.
    create_dataset = create_dummy_dataset = create_loader = None
