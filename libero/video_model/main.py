...
if __name__ == "__main__":
    ...
    try:
        ...
        if os.path.exists(logdir) and not opt.resume and not getattr(opt, 'resume_from_checkpoint', None):
            print(f'log folder {logdir} already exists.')
            exit()
        ...
        # This ignores whatever is in the YAML and forces the correct, 
        # stable strategy for your 2-GPU LIBERO training.
        # trainer_opt["strategy"] = DDPStrategy(
        #     static_graph=False, 
        #     find_unused_parameters=True
        # )
        
        # Ensure trainer_kwargs doesn't overwrite our forced strategy
